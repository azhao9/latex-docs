...
for dataset in DATASETS:
    ...
    unformatted_cmd = 'python3 classify.py --data %s --mode train --model-file %s --algorithm %s --online-learning-rate %f --online-training-iterations %d'
    cmd = unformatted_cmd % (data, model_file, ALGORITHM, 0.5, 1)
    os.system(cmd)
